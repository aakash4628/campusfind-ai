...
def home():
    ...
    <body>
        ...
        <form action="/report/lost" method="POST">
            ...
            Category:<br>
            <input type="text" name="category" placeholder="Phone / Wallet / ID Card">
            <br><br>
            ...
            Lost Location:<br>
            <input type="text" name="location" placeholder="Library / Canteen">
            <br><br>

            Time:<br>
            <input type="text" name="time" placeholder="10:30 AM">
            <br><br>
